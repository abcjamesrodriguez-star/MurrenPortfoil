...
export default function AboutMensaje() {
  ...
  return (
    <div className="relative w-full h-full text-white border-b md:border-b-0 md:border-r" style={{ backgroundColor: 'var(--color-surface-inverse)', borderColor: 'var(--color-border-inverse)' }}>
      ...
      <div className="flex flex-col h-full p-6 lg:p-8 lg:pt-12">
        ...
        <div className="mb-8">
          ...
          <h2 className="text-7xl lg:text-8xl xl:text-[110px] font-black uppercase tracking-tighter text-white leading-[0.8] -ml-1" style={{ fontFamily: 'Impact, sans-serif', transform: 'scaleY(1.1)', transformOrigin: 'left top' }}>
            MURREN.
          </h2>
        </div>
        ...
        <div className="mt-auto">
          ...
          <p className="text-[10px] lg:text-xs font-bold uppercase tracking-widest text-white underline underline-offset-4 decoration-2">
            {mensaje.cierre}
          </p>
        </div>
      </div>
