    ...
    <section className="w-full border-b border-neutral-200 bg-white text-black">
      <div className="grid grid-cols-1 lg:grid-cols-[280px_1fr] divide-y lg:divide-y-0 lg:divide-x divide-neutral-200">
        ...
        <div className="p-8 lg:p-12 flex flex-col justify-between">
          <div>
            <span className="text-[10px] font-bold tracking-[0.2em] uppercase block mb-6 text-neutral-700">
              // NUESTRA HISTORIA
            </span>
            <h2
              className="text-5xl lg:text-6xl font-bold uppercase leading-[1.1] tracking-tight text-black"
            >
              EL<br />ORIGEN.
            </h2>
          </div>
          ...
          <div className="mt-12 lg:mt-0">
            ...
            <span className="text-[10px] font-bold tracking-widest uppercase text-neutral-700">
              FUNDADA — 2019
            </span>
          </div>
        </div>
        ...
        >
          ...
          <div className="columns-1 md:columns-2 gap-12 text-sm text-neutral-800 leading-relaxed space-y-4">
