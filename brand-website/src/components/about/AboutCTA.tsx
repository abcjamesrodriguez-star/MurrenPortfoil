...
export default function AboutCTA() {
  ...
  return (
    <div className="relative w-full h-full p-6 lg:p-8 flex flex-col items-center justify-center bg-white min-h-[250px] lg:min-h-auto">
      ...
      {/* Tab Lateral Derecho */}
      <div className="hidden lg:block absolute right-0 top-1/2 -translate-y-1/2 -rotate-90 text-[10px] tracking-[0.2em] text-gray-400 whitespace-nowrap select-none pointer-events-none translate-x-1/2 z-10">
        CTA + REDES
      </div>

      {/* Caja interior geométrica con esquinas */}
      <div className="relative w-full max-w-sm aspect-square md:aspect-auto md:h-full flex flex-col items-center justify-center p-8 text-center border border-gray-100">
        ...
        <span className="text-[10px] font-bold tracking-widest uppercase text-gray-500 mb-6">
          {cta.eyebrow}
        </span>
        ...
        <span className="text-[10px] font-bold tracking-widest uppercase text-gray-400 mb-6">
          SÍGUENOS
        </span>
