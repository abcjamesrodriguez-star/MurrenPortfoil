  ...
  return (
    <section className="relative w-full border-b border-gray-200">
      ...
      <div className="flex flex-col lg:grid lg:grid-cols-[30%_40%_30%]">
        ...
        <div className="p-6 lg:p-8 flex flex-col justify-center relative border-b lg:border-b-0 lg:border-r border-gray-200">
          <motion.div
            initial="hidden"
            whileInView="visible"
            viewport={{ once: true }}
          ...
          >
            <motion.span 
              ...
              className="text-xs font-bold tracking-widest uppercase text-gray-500 mb-8 block"
            >
              {hero.eyebrow}
            </motion.span>
            ...
            <motion.p 
              variants={{ hidden: { opacity: 0, y: 20 }, visible: { opacity: 1, y: 0 } }}
              className="text-sm text-gray-600 max-w-[280px] leading-relaxed mb-12"
            >
              {hero.descripcion}
            </motion.p>
            ...
            <motion.div variants={{ hidden: { opacity: 0, y: 20 }, visible: { opacity: 1, y: 0 } }}>
              <Link 
                ...
                className="inline-flex items-center gap-2 text-xs font-bold uppercase tracking-widest text-black hover:text-gray-500 transition-colors border-b border-black hover:border-gray-500 pb-1 w-max group"
              >
                VER MANIFIESTO 
        ...
        <div className="flex flex-col justify-center border-b lg:border-b-0 lg:border-r border-gray-200 p-6 lg:p-12">
        ...
        <div className="p-6 lg:p-8 flex flex-col relative overflow-hidden">
          ...
          <motion.div 
            ...
            className="space-y-6 text-sm text-black leading-relaxed max-w-[300px] mt-auto lg:mt-0"
          >
